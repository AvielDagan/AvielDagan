    ...
    <div>
      ...
      <section class="bread">
        ...
        <li><a href="myUser.php">Main Menu</a></li>
          <li>//  <a href="check_reviews.php" class="selected">Check My Reviews</a></li>
        </ul>
      </section>
      <nav class="sidenav">
        <ul>
          ...
          <li><a href="check_reviews.php" class="selected" ><img src="images/review.png" alt=""> Check My Reviews</a></li>
        </ul>
      </nav>
    <div id="wrapper">
