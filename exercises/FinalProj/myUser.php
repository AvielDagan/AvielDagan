    ...
    <div>
      <nav class="navbar">
        ...
        <div id="mySidenav" class="sidenav1">
          ...
          <a href="myUser.php" ><img src="images/home.png"><span class="user">Home</span></a>
      ...
      <nav class="sidenav">
        <ul>
          ...
          <li><a href="check_reviews.php" class="review" ><img src="images/review.png" alt=""> Check My Reviews</a></li>
        </ul>
      </nav>
      <div id="wrapper">
        <main class="mainDemo">
        <h3 id="h3">Last Picks</h3>
            <div id="Last Picks"><!--id changed for all Types-->
            </div>
            <div class="clear"></div>
